...
enum AvailableCoinsType {
    ...
    ONLY_NONDENOMINATED_NOT1000000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 OBSR at the same time
...
public:
    ...
    */
    ...
    void setZObsAutoBackups(bool fEnabled)
    {
