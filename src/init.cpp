...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-backupzobs=<n>", strprintf(_("Enable automatic wallet backups triggered after each zOBSR minting (0-1, default: %u)"), 1));
...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        bool fEnableZObsBackups = GetBoolArg("-backupzobs", true);
        pwalletMain->setZObsAutoBackups(fEnableZObsBackups);
...
//    if (nAnonymizeObsrAmount < 2) nAnonymizeObsrAmount = 2;
    ...
    /* Denominations
       ...
       For example:
       1OBS+1000 == (.1OBS+100)*10
       10OBS+10000 == (1OBS+1000)*10
    */
