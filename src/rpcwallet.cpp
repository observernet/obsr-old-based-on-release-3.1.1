...
UniValue setaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("setaccount", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" \"tabby\"") + HelpExampleRpc("setaccount", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\", \"tabby\""));
...
UniValue getaccount(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("getaccount", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\"") + HelpExampleRpc("getaccount", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\""));
...
UniValue sendtoaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddress", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 0.1") +
            HelpExampleCli("sendtoaddress", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 0.1 \"donation\" \"seans outpost\"") +
            HelpExampleRpc("sendtoaddress", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue sendtoaddressix(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            "\nExamples:\n" +
            HelpExampleCli("sendtoaddressix", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 0.1") +
            HelpExampleCli("sendtoaddressix", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 0.1 \"donation\" \"seans outpost\"") +
            HelpExampleRpc("sendtoaddressix", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\", 0.1, \"donation\", \"seans outpost\""));
...
UniValue signmessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 2)
        throw runtime_error(
            ...
            HelpExampleCli("signmessage", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" \"my message\"") +
            "\nVerify the signature\n" +
            HelpExampleCli("verifymessage", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" \"signature\" \"my message\"") +
            "\nAs json rpc\n" +
            HelpExampleRpc("signmessage", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\", \"my message\""));
...
UniValue getreceivedbyaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            HelpExampleCli("getreceivedbyaddress", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n" +
            HelpExampleCli("getreceivedbyaddress", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n" +
            HelpExampleCli("getreceivedbyaddress", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 6") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("getreceivedbyaddress", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\", 6"));
...
UniValue sendfrom(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 3 || params.size() > 6)
        throw runtime_error(
            ...
            HelpExampleCli("sendfrom", "\"\" \"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n" +
            HelpExampleCli("sendfrom", "\"tabby\" \"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendfrom", "\"tabby\", \"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\", 0.01, 6, \"donation\", \"seans outpost\""));
...
UniValue sendmany(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 4)
        throw runtime_error(
            ...
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\\\":0.01,\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n" +
            HelpExampleCli("sendmany", "\"tabby\" \"{\\\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\\\":0.01,\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\":0.02}\" 6 \"testing\"") +
            "\nAs a json rpc call\n" +
            HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\\\":0.01,\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\":0.02}\", 6, \"testing\""));
...
UniValue addmultisigaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            HelpExampleCli("addmultisigaddress", "2 \"[\\\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\\\",\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\"]\"") +
            "\nAs json rpc call\n" +
            HelpExampleRpc("addmultisigaddress", "2, \"[\\\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\\\",\\\"DAD3Y6ivr8nPQLT1NEPX84DxGCw9jz9Jvg\\\"]\""));
...
UniValue walletlock(const UniValue& params, bool fHelp)
{
    if (pwalletMain->IsCrypted() && (fHelp || params.size() != 0))
        throw runtime_error(
            ...
            HelpExampleCli("sendtoaddress", "\"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\" 1.0") +
...
UniValue mintzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. amount      (numeric, required) Enter an amount of Obs to convert to zOBSR\n"
...
UniValue spendzerocoin(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 5 || params.size() < 4)
        throw runtime_error(
            ...
            "\nExamples\n" +
            HelpExampleCli("spendzerocoin", "5000 false true 100 \"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\"") +
            HelpExampleRpc("spendzerocoin", "5000 false true 100 \"oRm3icPLfK9Y3DPGoQXDGQaw9LoeFQgRWq\""));
...
UniValue dzobsrstate(const UniValue& params, bool fHelp) {
    ...
    obj.push_back(Pair("dzobs_count", nCount));
...
void static SearchThread(CzOBSRWallet* zwallet, int nCountStart, int nCountEnd)
{
    ...
    try {
        ...
        for(int i = nCountStart; i < nCountEnd; i++) {
            ...
            CKey key;
            zwallet->SeedToZOBS(zerocoinSeed, bnValue, bnSerial, bnRandomness, key);
...
UniValue searchdzobs(const UniValue& params, bool fHelp)
{
    if(fHelp || params.size() != 3)
        throw runtime_error(
            "searchdzobs\n"
            ...
            "\nExamples\n" +
            HelpExampleCli("searchdzobs", "1, 100, 2") + HelpExampleRpc("searchdzobs", "1, 100, 2"));
